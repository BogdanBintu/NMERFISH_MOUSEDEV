...
#activate cellpose&&python "C:\Scripts\NMERFISH\worker_Scope1__EmbryoPlateE1V2.py"

master_analysis_folder = r'C:\Scripts\NMERFISH'
lib_fl = r'C:\Scripts\NMERFISH\codebooks\blank_codebook_Mahsa_DevEP1-code_color2__comb16-4-4.csv'
...
save_folder =r'\\192.168.0.6\bbfishjoy4extra\MERFISH_AnalysisE1'
iHm=1+16*4
iHM=16*5
...
def main_f(set_ifov,redo_fits = False,redo_drift=True,redo_decoding=True,try_mode=True,old_method=False):
    set_,ifov = set_ifov
...
if __name__ == '__main__':
    ...
    items = [(set_,ifov)for set_ in ['_D9']#['_D7','_D9','_D13','_D14','_D16'][::-1]#['_set1','_set2','_set3']
                        for ifov in range(500)]
