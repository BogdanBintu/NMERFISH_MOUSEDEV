...
#activate cellpose&&python "C:\Scripts\NMERFISH\worker_Scope1__EmbryoPlate12V3.py"

master_analysis_folder = r'C:\Scripts\NMERFISH'
lib_fl = r'C:\Scripts\NMERFISH\codebooks\blank_codebook_Mahsa_DevP1P2-code_color2__comb16-4-4.csv'
